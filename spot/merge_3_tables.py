#!/usr/bin/env python3
"""
Merge spot trading tables into a unified DataFrame.
...
class TableMerger:
    """Merge spot tables into a unified dataset."""
    ...
    def __init__(self, data_filter: DataFilter, output_dir: str = './output_train'):
        ...
        # Define table priority and merge strategies (3 core tables)
