#!/usr/bin/env python3
"""
Load data from spot trading tables with filtering capabilities.
...
class DatabaseLoader:
    """Load data from spot tables with filtering capabilities."""
    ...
    def __init__(self, data_filter: DataFilter, output_dir: str = './output_train',
        ...
        # Define spot table schemas (3 core tables)
        self.tables = {
            ...
            'cg_spot_aggregated_taker_volume_history': {
                ...
                'data_columns': ['aggregated_buy_volume_usd', 'aggregated_sell_volume_usd', 'unit'],
                'pair_mode': 'base'
            },
    ...
    def _normalize_base_symbol(self, symbol: str) -> str:
        """Normalize pair/symbol to base asset for spot tables."""
        if not symbol:
            return symbol
