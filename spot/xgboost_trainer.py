#!/usr/bin/env python3
"""
XGBoost trainer for binary classification of spot trend prediction.
...
class XGBoostTrainer:
    ...
    def save_model_and_results(self, model: xgb.XGBClassifier,
        ...
        # Save threshold recommendations for QC usage
        thresholds_path = self.output_dir / 'model_thresholds.json'
        try:
            thresholds_payload = {
                "best_precision_threshold": results["metrics"].get("best_precision_threshold"),
                "best_precision": results["metrics"].get("best_precision"),
                "best_f1_threshold": results["metrics"].get("best_f1_threshold"),
                "best_f1": results["metrics"].get("best_f1"),
            }
