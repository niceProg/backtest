...
async def get_futures_new_gen_btc_bybit_latest_model():
    """Get latest futures_new_gen_btc_bybit trained model with base64 encoding."""
    return get_latest_model_by_version('futures_new_gen_btc_bybit')

@app.get("/api/v1/futures_new_gen_btc_bybit/latest/dataset-summary", response_model=DatasetSummaryResponse)
async def get_futures_new_gen_btc_bybit_latest_dataset_summary():
    """Get latest futures_new_gen_btc_bybit dataset summary with base64 encoding."""
    return get_dataset_summary_by_version('futures_new_gen_btc_bybit')

@app.get("/api/v1/futures_new_gen_btc_bybit/summary/{summary_id}", response_model=DatasetSummaryResponse)
async def get_futures_new_gen_btc_bybit_summary_by_id(summary_id: int):
    """Get futures_new_gen_btc_bybit dataset summary by specific ID."""
    return get_summary_by_id_version(summary_id, 'futures_new_gen_btc_bybit')

@app.get("/api/v1/futures_new_gen_btc_bybit/model/{model_id}", response_model=ModelResponse)
async def get_futures_new_gen_btc_bybit_model_by_id(model_id: int):
    """Get futures_new_gen_btc_bybit model by specific ID."""
    return get_model_by_id_version(model_id, 'futures_new_gen_btc_bybit')

@app.get("/api/v1/futures_new_gen_btc_bybit/models", response_model=ModelsResponse)
async def list_futures_new_gen_btc_bybit_models():
    """List all available futures_new_gen_btc_bybit models."""
    return list_models_by_version('futures_new_gen_btc_bybit')

@app.post("/api/v1/futures_new_gen_btc_bybit/model", response_model=ModelInsertResponse)
async def insert_futures_new_gen_btc_bybit_model(model_request: ModelInsertRequest):
    """Insert a new futures_new_gen_btc_bybit trained model to the database."""
    return insert_model_by_version(model_request, 'futures_new_gen_btc_bybit')

# FUTURES NEW GEN ETH BYBIT ENDPOINTS (/api/v1/futures_new_gen_eth_bybit/*)
@app.get("/api/v1/futures_new_gen_eth_bybit/latest/model", response_model=ModelResponse)
async def get_futures_new_gen_eth_bybit_latest_model():
    """Get latest futures_new_gen_eth_bybit trained model with base64 encoding."""
    return get_latest_model_by_version('futures_new_gen_eth_bybit')

@app.get("/api/v1/futures_new_gen_eth_bybit/latest/dataset-summary", response_model=DatasetSummaryResponse)
async def get_futures_new_gen_eth_bybit_latest_dataset_summary():
    """Get latest futures_new_gen_eth_bybit dataset summary with base64 encoding."""
    return get_dataset_summary_by_version('futures_new_gen_eth_bybit')

@app.get("/api/v1/futures_new_gen_eth_bybit/summary/{summary_id}", response_model=DatasetSummaryResponse)
async def get_futures_new_gen_eth_bybit_summary_by_id(summary_id: int):
    """Get futures_new_gen_eth_bybit dataset summary by specific ID."""
    return get_summary_by_id_version(summary_id, 'futures_new_gen_eth_bybit')

@app.get("/api/v1/futures_new_gen_eth_bybit/model/{model_id}", response_model=ModelResponse)
async def get_futures_new_gen_eth_bybit_model_by_id(model_id: int):
    """Get futures_new_gen_eth_bybit model by specific ID."""
    return get_model_by_id_version(model_id, 'futures_new_gen_eth_bybit')

@app.get("/api/v1/futures_new_gen_eth_bybit/models", response_model=ModelsResponse)
async def list_futures_new_gen_eth_bybit_models():
    """List all available futures_new_gen_eth_bybit models."""
    return list_models_by_version('futures_new_gen_eth_bybit')

@app.post("/api/v1/futures_new_gen_eth_bybit/model", response_model=ModelInsertResponse)
async def insert_futures_new_gen_eth_bybit_model(model_request: ModelInsertRequest):
    """Insert a new futures_new_gen_eth_bybit trained model to the database."""
    return insert_model_by_version(model_request, 'futures_new_gen_eth_bybit')
...
if __name__ == "__main__":
    ...
    logger.info("   GET /api/v1/futures_new_gen_btc_bybit/summary/{summary_id} - Get futures_new_gen_btc_bybit dataset summary by ID")
    logger.info("   GET /api/v1/futures_new_gen_btc_bybit/models - List all futures_new_gen_btc_bybit models")
    logger.info("   POST /api/v1/futures_new_gen_btc_bybit/model - Insert new futures_new_gen_btc_bybit model")
    logger.info("   GET /api/v1/futures_new_gen_eth_bybit/latest/model - Get latest futures_new_gen_eth_bybit model")
    logger.info("   GET /api/v1/futures_new_gen_eth_bybit/latest/dataset-summary - Get latest futures_new_gen_eth_bybit dataset summary")
    logger.info("   GET /api/v1/futures_new_gen_eth_bybit/model/{model_id} - Get futures_new_gen_eth_bybit model by ID")
    logger.info("   GET /api/v1/futures_new_gen_eth_bybit/summary/{summary_id} - Get futures_new_gen_eth_bybit dataset summary by ID")
    logger.info("   GET /api/v1/futures_new_gen_eth_bybit/models - List all futures_new_gen_eth_bybit models")
    logger.info("   POST /api/v1/futures_new_gen_eth_bybit/model - Insert new futures_new_gen_eth_bybit model")
    logger.info("")
