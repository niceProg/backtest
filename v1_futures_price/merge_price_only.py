#!/usr/bin/env python3
"""
Merge futures price table into a unified DataFrame.
Price-only pipeline (no other futures tables).
"""
...
class TableMerger:
    ...
    def merge_all_tables(self, all_data: Dict[str, pd.DataFrame]) -> pd.DataFrame:
        ...
        # No extra tables in price-only pipeline; sort for consistency
