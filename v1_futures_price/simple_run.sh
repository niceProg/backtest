...
OUTPUT_DIR=${OUTPUT_DIR:-./output_train_futures_price}
...
run_step "merge_price_only.py" "Step 2: Merge Price Table" $EXTRA_FLAGS
...
echo ""
echo "Next steps:"
echo "1. Access structured API: http://localhost:8000/output_train_futures_price/"
echo "2. View latest model: http://localhost:8000/output_train_futures_price/models/latest"
echo "3. View dataset summary: http://localhost:8000/output_train_futures_price/datasets/summary"
echo ""
