...
class DatasetSummary(Base):
    ...
    model_version = Column(String(50), default='futures17')  # 'spot', 'futures', or 'futures17'
...
class DatabaseStorage:
    ...
    def store_model(self,
                   ...
                   model_version: str = 'futures17') -> int:
...
#     logger.info("❌ Evaluation results storage disabled per client requirement")
    ...
    def load_latest_model(self, model_version: str = 'futures17') -> tuple:
