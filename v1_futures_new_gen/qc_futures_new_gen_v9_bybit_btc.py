...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.objectstore_prefix = "yumna_btc_bybit_v9"
        ...
        # ===== Strategy meta =====
        self.strategy_name = "Metode: Futures New Gen v9 BTC Bybit - DragonFortune"
        self.strategy_id = 13
