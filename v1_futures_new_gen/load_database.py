...
Futures-only with 6 core tables (price, funding, basis, taker, OI, top L/S).
"""
...
class DatabaseLoader:
    ...
    def __init__(self, data_filter: DataFilter, output_dir: str = './output_train',
        ...
        # Define futures table schemas (6 core tables)
        self.tables = {
    ...
    def load_data_from_csv_files(self, csv_dir: str) -> Dict[str, pd.DataFrame]:
        ...
        # Expected CSV filenames (futures, 6 core tables)
        csv_files = {
...
def main():
    ...
    try:
        ...
        if all_data:
            ...
            logger.info("Ready for merge_6_tables.py")
        else:
