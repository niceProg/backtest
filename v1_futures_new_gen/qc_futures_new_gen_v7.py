...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.model_api_url = f"{self.domain}/api/{self.model_version}/futures_new_gen_btc_binance/latest/model"
        self.dataset_summary_api_url = f"{self.domain}/api/{self.model_version}/futures_new_gen_btc_binance/latest/dataset-summary"
        ...
        self.short_entry_threshold = 0.54
