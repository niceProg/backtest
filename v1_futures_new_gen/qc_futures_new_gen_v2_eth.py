...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # ===== Strategy meta =====
        self.strategy_name = "Metode: Futures New Gen v2 ETH - DragonFortune"
        self.strategy_id = 12
        ...
        # ===== Trading parameters =====
        self.prediction_buy_threshold = 0.505
        self.prediction_sell_threshold = 0.495
        ...
        self.min_volatility = 0.004  # 0.4% hourly volatility floor
    ...
    def TradeLogic(self, pred: float):
        ...
        if self.use_trend_filter:
            ...
            short_ok = self.fast_ema.Current.Value < self.slow_ema.Current.Value
