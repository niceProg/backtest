...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # ===== Strategy meta =====
        self.strategy_name = "Metode: Futures New Gen v4 BTC Bybit - DragonFortune"
        self.strategy_id = 12
        ...
        # ===== Trading parameters =====
        # Base thresholds (from training_results_20260202_120727):
        # - best_precision_threshold=0.46
        # - best_f1_threshold=0.40
        self.prediction_buy_threshold = 0.50
        self.prediction_sell_threshold = 0.44
        self.short_entry_threshold = 0.46
        # Offset applied on top of sell_th to allow shorts when model is biased high
        self.short_entry_offset = 0.02
