...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # ===== Strategy meta =====
        self.strategy_name = "Metode: Futures New Gen v1 - DragonFortune"
        self.strategy_id = 10
        ...
        # ===== Trading parameters =====
        self.prediction_buy_threshold = 0.504
        self.prediction_sell_threshold = 0.496
        ...
        self.pred_smooth_n = 3   # moving average window for prediction smoothing
