...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # ===== Trading parameters =====
        self.prediction_buy_threshold = 0.51
        self.prediction_sell_threshold = 0.49
        self.position_size_pct = 1.00
        ...
        self.min_hold_bars = 0  # minimum holding bars before prediction-based exit
        ...
        self.min_pred_exit_pnl_pct = 0.01
    ...
    def TradeLogic(self, pred: float):
        ...
        # ENTRY SHORT
        elif pred < self.current_sell_threshold and qty == 0 and not self.pending_entry and not self.pending_exit:
            self.pending_entry = True
            self.entry_price = float(self.Securities[self.symbol].Price)  # provisional
            self.entry_time = self.Time
            self.entry_direction = -1
