...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.objectstore_prefix = "yumna_eth"
        ...
        self.model_api_url = f"{self.domain}/api/{self.model_version}/futures_new_gen_eth/latest/model"
        self.dataset_summary_api_url = f"{self.domain}/api/{self.model_version}/futures_new_gen_eth/latest/dataset-summary"
        ...
        self.crypto = self.AddCryptoFuture("ETHUSDT", Resolution.Hour, Market.Binance)
        ...
        # ===== Strategy meta =====
        self.strategy_name = "Metode: Futures New Gen v3 ETH - DragonFortune"
        self.strategy_id = 13
    ...
    def TradeLogic(self, pred: float):
        ...
        # Trend/volatility filters (ETH-specific)
        long_ok = True
