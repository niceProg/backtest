...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.objectstore_prefix = "yumna_btc_bybit_v8"
        ...
        # ===== Strategy meta =====
        self.strategy_name = "Metode: Futures New Gen v8 BTC Bybit - DragonFortune"
        self.strategy_id = 13
        ...
        # ===== Trading parameters =====
        self.prediction_buy_threshold = 0.565
        self.prediction_sell_threshold = 0.445
        self.short_entry_threshold = 0.50
    ...
    def TradeLogic(self, pred: float):
        ...
        # ENTRY SHORT
        elif pred < self.short_entry_threshold and qty >= 0 and not self.pending_entry and not self.pending_exit and short_ok:
            self.pending_entry = True
            self.entry_price = float(self.Securities[self.symbol].Price)  # provisional
            self.entry_time = self.Time
            self.entry_direction = -1
