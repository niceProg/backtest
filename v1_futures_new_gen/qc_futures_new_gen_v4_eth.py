...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # ===== Strategy meta =====
        self.strategy_name = "Metode: Futures New Gen v4 ETH - DragonFortune"
        self.strategy_id = 14
        ...
        # ===== Trading parameters =====
        self.prediction_buy_threshold = 0.53
        self.prediction_sell_threshold = 0.47
    ...
    def CheckStopLossTakeProfit(self, price: float) -> bool:
        try:
            ...
            if pnl_pct <= -self.stop_loss_pct:
                ...
                exit_jenis = "sell" if qty > 0 else "buy_to_cover"
