...
class XGBoostTradingAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.objectstore_prefix = "yumna_eth_bybit_v1"
        ...
        self.model_api_url = f"{self.domain}/api/{self.model_version}/futures_new_gen_eth_bybit/latest/model"
        self.dataset_summary_api_url = f"{self.domain}/api/{self.model_version}/futures_new_gen_eth_bybit/latest/dataset-summary"
        ...
        self.crypto = self.AddCryptoFuture("ETHUSDT", Resolution.Hour, Market.Bybit)
        ...
        # ===== Strategy meta =====
        self.strategy_name = "Metode: Futures New Gen v1 ETH Bybit - DragonFortune"
        self.strategy_id = 10
